<div class="form-group row">
    ...
    <div class="col-lg-8">
        <input type="text" name="nombre" id="nombre" class="form-control ml-3" value="" required/>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-lg-8">
        <input type="text" name="url" id="url" class="form-control ml-3" value="" required/>          
    </div>  
</div>
...
<div class="form-group row">
    ...
    <div class="col-lg-8">
        <input type="text" name="icono" id="icono" class="form-control ml-3" value=""/>
    </div>  
</div>